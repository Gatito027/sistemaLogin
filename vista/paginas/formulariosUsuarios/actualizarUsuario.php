    ...
    <div id="formulario">
        <ul>
            ...
            <div id="formularioUsuario">
                <form id="frmUsuario" name="frmUsuario" action="../../../controlador/editarUsuario.php" class="was-validated" method="post">
                    <label for="">
                    ...
                    <div id="form-group">
                        ...
                        <input type="text" name="txtId" id="txtid uname" class="form-control"
                            placeholder="id del perfil" required>
                    ...
                    <div id="form-group">
                        <label for="uname">Apellidos Paterno:</label><br>
                        <input type="text" name="txtApePaterno" id="txtApePaterno uname" class="form-control"
                            placeholder="Ingresa apellido paterno" required>
                        <div class="valid-feedback">Valido.</div>
                        <div class="invalid-feedback">Llena este campo.</div>
                    </div>
                    <div id="form-group">
                        <label for="uname">Apellidos Materno:</label><br>
                        <input type="text" name="txtApeMaterno" id="txtApeMaterno uname" class="form-control"
                    ...
                    <div id="form-group">
                        ...
                        <input type="email" name="txtEmail" id="txtEmail uname" class="form-control"
                            placeholder="Ingresa un E-mail" required>
                        <div class="valid-feedback">Valido.</div>
                        <div class="invalid-feedback">Llena este campo.</div>
                    </div>
                    <div id="form-group">
                        <label for="uname">Telefono:</label><br>
                        <input type="number" name="txtTelefono" id="txtTelefono uname" class="form-control"
                            placeholder="Ingresa un telefono" required>
                        <div class="valid-feedback">Valido.</div>
                        <div class="invalid-feedback">Llena este campo.</div>
                    </div>
                    <div id="form-group">
                        <label for="uname">Status:</label><br>
                        <input type="number" name="txtStatus" id="txtStatus uname" class="form-control"
                            placeholder="Ingresa un estado de perfil" required>
                        <div class="valid-feedback">Valido.</div>
                        <div class="invalid-feedback">Llena este campo.</div>
                    </div>
                    <br>
